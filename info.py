...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001980601454')).split()]
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/ary_botz')
...
MSG_ALRT = environ.get('MSG_ALRT', '404 No active service')
